/**
 * @link https://github.com/type-challenges/type-challenges/blob/main/questions/00651-hard-length-of-string/README.md
 */

import type { Equal, IsTrue } from '@type-challenges/utils'

type Split<S extends string, Arr extends unknown[] = []> = S extends `${infer F}${infer R}`
  ? Split<R, [F, ...Arr]>
  : Arr
